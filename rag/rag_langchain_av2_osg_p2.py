...
Please provide the output strictly in JSON format with no comments and no explanations. The assigned IDs should NOT be osm_ids. The assigned IDs should be of the format 0, 1, 2, ... Generate detail road information for each input ID"
